    ...
    return (
      ...
      <body className="home-body d-flex align-items-center">
        ...
        <div className="container text-center">
            ...
            <a href="/photos/new" className="btn btn-primary btn-lg active mr-2 btn-outline-dark" role="button" aria-pressed="true">
            add photo</a>
            <a href="/album/new" className="btn btn-primary btn-lg active ml-2 btn-outline-dark" role="button" aria-pressed="true">
            create album</a>
        </div>
      </body>
    </html>
